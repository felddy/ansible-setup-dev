...
issue](https://github.com/felddy/ansible-setup-dev/issues) in
...
request](https://github.com/felddy/ansible-setup-dev/pulls), you
...
```bash
cd ansible-setup-dev
pyenv virtualenv <python_version_to_use> ansible-setup-dev
pyenv local ansible-setup-dev
