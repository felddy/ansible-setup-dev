...
issue](https://github.com/felddy/ansbile-setup-dev/issues) in
...
request](https://github.com/felddy/ansbile-setup-dev/pulls), you
...
```bash
cd ansbile-setup-dev
pyenv virtualenv <python_version_to_use> ansbile-setup-dev
pyenv local ansbile-setup-dev
